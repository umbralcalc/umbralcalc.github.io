...
Instead of communicating conceptual understanding with mathematical symbols, the posts on this blog use a _diagrammatic language_ instead.
...
<center><img src="../assets/mathematical_symbols_vs_diagrams/diagrams-vs-symbols.svg" width="700"/></center>

## Mathematical rigour

The diagrammatic language we use owes its mathematical rigour to the fact that [any computation can be written as a series of function abstrations and applications](https://en.wikipedia.org/wiki/Lambda_calculus). 
...
<center><img src="../assets/mathematical_symbols_vs_diagrams/maths-to-diagrams.svg" width=600/></center>
