...
<p class="description">Rugby manager decision support: pick when each home position group comes off the pitch; the simulator (fitted to thousands of real match events) shows how the win-margin distribution shifts.</p>
<div class="dashboard">
    <section class="panel">
